...
下表用于编写软件说明书、功能模块说明和操作截图清单。最终截图计划在 2026-10-07 至 10-12 期间基于申请版本候选提交采集，并在 2026-10-13 冻结；截图或结果只能来自已完成并可复核的入口。
...
- 软著申请或登记尚未完成；当前已进入申请版本材料准备，目标 2026-10-15 完成提交准备，受理和登记结果仍取决于官方流程。
...
3. 保持 M07 页面级回归和 M06 离线任务边界稳定；按倒排计划在 2026-10-07 至 10-12 采集申请版本截图，并在冻结提交上复核。
4. 在阶段五系统集成完成后，统一模块名称、用户操作说明、软件版本和证据索引。
5. 按 2026-10-13 冻结、2026-10-15 提交准备的倒排计划，完成全量回归、截图、说明书和代码鉴别材料，再提交申请。
