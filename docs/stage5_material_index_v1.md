...
| 当前清单 SHA-256 | `f405f4b6f62f9de6587c9d9a0a1016caf89a24f3e2d093572e7ac53457dee151` |
| 当前清单关键计数 | M03 `117` 个场景；M07 `117` 行、`351` 条严格验收来源证据 |

当前 SHA-256 对应 2026-08-31 本机 `Carla666-0916` 环境的一次通过运行。由于 `artifacts/` 不入 Git，正式申请前必须在最终冻结提交上重新运行并更新本表，不得把当前哈希当作最终版本哈希。
