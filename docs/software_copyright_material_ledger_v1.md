...
> 当前调度状态（2026-09-23）：软著申请版本准备已启动，目标 2026-10-15 完成材料包并提交。台账只记录已实现、可复核的代码入口、测试结果、运行证据和边界；最终截图、说明书、代码鉴别材料和申请信息必须从同一冻结提交生成。
...
申请版本在 2026-10-13 冻结，2026-10-15 完成提交准备。至少满足以下条件：
...
申请版本提交后，继续迭代的候选工作区、服务器 Job 自动回链和多用户能力另行建立版本记录；不得回写为本次申请版本已具备。
