...
2. 如需增加 Traffic Manager 种子，只对扩展 CVAE/critical SAC 和 LHS/high 高碰撞 pair 做重复测量，不扩大独立样本数，也不重复已完成的独立场景。
